...
module.exports = class extends think.Model {
  ...
  async getLatestOrderExpress(orderId) { // 这个是快递鸟的接口，查不了顺丰。顺丰用阿里云的付费接口，在order.js中已经写好
    ...
    const latestExpressInfo = await ExpressSerivce.queryExpress(orderExpress.shipper_code, orderExpress
      .logistic_code);
  ...
  async getExpressInfo(shipperName, expressNo) {
    ...
    const options = {
      ...
      url: 'http://wuliu.market.alicloudapi.com/kdi?no=' + expressNo,
      // url: 'http://wuliu.market.alicloudapi.com/kdi?no=' + 433033434012546 + '&type=' + shipperName,
      // url: 'http://wuliu.market.alicloudapi.com/kdi?no=' + 433033434012546,
      headers: {
    ...
    console.log(JSON.stringify(sessionData, 2, null))
